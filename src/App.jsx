...
function App() {
  ...
  const [selectedHistory,setselcHistory] = useState('')
...
if (darkMode=='dark') {
  ...
  return (
    ...
    <div className='grid grid-cols-5 h-screen text-center'>
     ...
     <RecentSearch recenthistory={recenthistory} setrecentHistory={setrecentHistory} setselcHistory={setselcHistory}/>
      <div className='col-span-4 p-10'>
        <h1 className=' mb-2 text-4xl bg-clip-text text-transparent bg-gradient-to-r from-pink-700 to-violet-700'>
    ...
    <span className="sr-only">Loading...</span>
        ...
        <div className='dark:bg-zinc-800 bg-red-100 w-1/2 mt-5 items-center p-4 pr-5 dark:text-white  text-zinc-800 rounded-4xl border border-zinc-600 flex h-16 m-auto'>
          <input type="text" className='w-full h-full outline-none ' placeholder='Ask me Anything' onKeyDown={isEnter} onChange={(event) => setQuestion(event.target.value)} />
